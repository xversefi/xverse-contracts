...
import "@xverseprojects/v3-periphery/contracts/base/PeripheryImmutableState.sol";
...
import "@xverseprojects/v3-periphery/contracts/libraries/Path.sol";
...
contract MixedRouteQuoterV1 is
    IMixedRouteQuoterV1,
    IXVerseV3SwapCallback,
    PeripheryImmutableState
{
    ...
    */
    ...
    function xverseV3SwapCallback(
        ...
        IXVerseV3Pool pool = SmartRouterHelper.getPool(
            deployer,
            tokenIn,
            tokenOut,
            fee
    ...
    function quoteExactInputSingleV2(
        ...
        amountOut = SmartRouterHelper.getAmountOut(
            params.amountIn,
            reserveIn,
            reserveOut
        );
    ...
    function quoteExactInputSingleStable(
        ...
        (uint256 i, uint256 j, address swapContract) = SmartRouterHelper
            .getStableInfo(
                factoryStable,
                params.tokenIn,
                params.tokenOut,
