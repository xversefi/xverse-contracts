...
import "@xverseprojects/v3-periphery/contracts/base/BlockTimestamp.sol";
import "@xverseprojects/v3-periphery/contracts/libraries/Path.sol";
import "@xverseprojects/v3-periphery/contracts/libraries/PoolAddress.sol";
import "@xverseprojects/v3-core/contracts/interfaces/IXVerseV3Pool.sol";
import "@xverseprojects/v3-periphery/contracts/libraries/OracleLibrary.sol";
    ...
    BlockTimestamp
{
    ...
    function getPoolAddress(
        ...
        address tokenB,
        uint24 fee
    ) internal view virtual returns (IXVerseV3Pool pool) {
        pool = IXVerseV3Pool(
        ...
        returns (int256 syntheticAverageTick, int256 syntheticCurrentTick)
    {
        ...
        for (uint256 i = 0; i < numPools; i++) {
            ...
            (address tokenIn, address tokenOut, uint24 fee) = path
                .decodeFirstPool();
            IXVerseV3Pool pool = getPoolAddress(tokenIn, tokenOut, fee);
            ...
            if (secondsAgo == 0) {
                ...
                (, currentTick, , , , , ) = IXVerseV3Pool(pool).slot0();
            }
