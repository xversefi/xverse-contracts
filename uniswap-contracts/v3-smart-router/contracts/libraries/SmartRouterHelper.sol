...
import "@xverseprojects/v3-core/contracts/libraries/LowGasSafeMath.sol";
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x43d64c3eecf4fe419d84e2bb1530cbaf16529bc98443a9c0a6044800e3975755;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xde0f460cc415e65837e7d5ccdf60f3b663b0ba4ede744a6d8cb5299caf11feb0;
    ...
    /// @param deployer The XVerse V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IXVerseV3Pool) {
        return
            IXVerseV3Pool(
    ...
    /// @notice Returns the address of a valid XVerse V3 Pool
    /// @param deployer The contract address of the XVerse V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IXVerseV3Pool pool) {
    ...
    function verifyCallback(
        ...
        pool = IXVerseV3Pool(computeAddress(deployer, poolKey));
