...
/// @title XVerse V2 Swap Router
/// @notice Router for stateless execution of swaps against XVerse V2
    ...
    ReentrancyGuard
{
    ...
    function swapExactTokensForTokens(
        ...
        require(amountOut >= amountOutMin, "swapExactTokensForTokens: amountOut >= amountOutMin");
    }
    ...
    function swapTokensForExactTokens(
        ...
        require(amountIn <= amountInMax, "swapTokensForExactTokens: amountIn <= amountInMax");
