...
import '@xverseprojects/v3-core/contracts/libraries/Tick.sol';
import '../interfaces/IXVerseNonfungiblePositionManager.sol';
import './LiquidityAmounts.sol';
import './PoolAddress.sol';
import './PositionKey.sol';

/// @title Returns information about the token value held in a XVerse V3 NFT
library PositionValue {
    /// @notice Returns the total amounts of token0 and token1, i.e. the sum of fees and principal
    /// that a given nonfungible position manager token is worth
    /// @param positionManager The XVerse V3 NonfungiblePositionManager
    ...
    function total(
        IXVerseNonfungiblePositionManager positionManager,
        uint256 tokenId,
