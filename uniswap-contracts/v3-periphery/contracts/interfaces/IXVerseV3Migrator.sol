...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from XVerseSwap v2-compatible pairs into XVerseSwap v3 pools
interface IXVerseV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the XVerseSwap v2-compatible pair
