...
/// @title NFT positions
/// @notice Wraps XVerse V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the xverse position
    struct Position {
    ...
    constructor(
        ...
        ERC721Permit('XVerse V3 Positions NFT-V1', 'PCS-V3-POS', '1')
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IXVerseV3Pool pool = IXVerseV3Pool(PoolAddress.computeAddress(deployer, poolKey));
