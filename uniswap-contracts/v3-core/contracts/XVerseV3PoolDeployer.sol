...
import './XVerseV3Pool.sol';

contract XVerseV3PoolDeployer is IXVerseV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IXVerseV3PoolDeployer
    ...
    /// @param factory The contract address of the XVerseSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new XVerseV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
