...
/// @title The interface for the XVerseSwap V3 Factory
/// @notice The XVerseSwap V3 Factory facilitates creation of XVerseSwap V3 pools and control over the protocol fees
interface IXVerseV3Factory {
