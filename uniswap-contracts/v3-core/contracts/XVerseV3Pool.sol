...
import './interfaces/IXVerseV3Pool.sol';
...
import './interfaces/IXVerseV3PoolDeployer.sol';
import './interfaces/IXVerseV3Factory.sol';
import './interfaces/IERC20Minimal.sol';
import './interfaces/callback/IXVerseV3MintCallback.sol';
import './interfaces/callback/IXVerseV3SwapCallback.sol';
import './interfaces/callback/IXVerseV3FlashCallback.sol';

import '@xverseprojects/v3-lm-pool/contracts/interfaces/IXVerseV3LmPool.sol';

contract XVerseV3Pool is IXVerseV3Pool {
    ...
    /// @inheritdoc IXVerseV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IXVerseV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IXVerseV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IXVerseV3PoolDerivedState
    ...
    /// @inheritdoc IXVerseV3PoolActions
    ...
    function mint(
        ...
        IXVerseV3MintCallback(msg.sender).xverseV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IXVerseV3SwapCallback(msg.sender).xverseV3SwapCallback(amount0, amount1, data);
    ...
    function flash(address recipient, uint256 amount0, uint256 amount1, bytes calldata data) external override lock {
        ...
        IXVerseV3FlashCallback(msg.sender).xverseV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IXVerseV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
        lmPool = IXVerseV3LmPool(_lmPool);
