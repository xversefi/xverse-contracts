...
import "./interfaces/IXVerseLMPoolDeployer.sol";
import "./interfaces/IFarmBooster.sol";
import "./interfaces/IWETH.sol";
import "./utils/Multicall.sol";
import "./Enumerable.sol";

contract XVerseMasterChefV3 is INonfungiblePositionManagerStruct, Multicall, Ownable, ReentrancyGuard, Enumerable {
    using SafeERC20 for IERC20;
    using SafeCast for uint256;
    struct PoolInfo {
        uint256 allocPoint;
        // V3 pool address
        IXVerseV3Pool v3Pool;
    ...
    IXVerseLMPoolDeployer public LMPoolDeployer;
    ...
    event AddPool(uint256 indexed pid, uint256 allocPoint, IXVerseV3Pool indexed v3Pool, ILMPool indexed lmPool);
    ...
    // constructor(address _CAKE, INonfungiblePositionManager _nonfungiblePositionManager, address _WETH) {
    ...
    function setLMPoolDeployer(IXVerseLMPoolDeployer _LMPoolDeployer) external onlyOwner {
    ...
    function add(uint256 _allocPoint, IXVerseV3Pool _v3Pool, bool _withUpdate) external onlyOwner {
    ...
    function onERC721Received(
        ...
        if (msg.sender != address(nonfungiblePositionManager)) revert NotXVerseNFT();
